...
const register = asyncHandler(async (req, res) => {
  const { firstName, lastName, email, password, role, phoneNumber, organizationName } = req.body;
  ...
  // Add organization name for managers
  if (userData.role === 'Manager' && organizationName) {
